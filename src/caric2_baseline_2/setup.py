...
package_name = "caric2_baseline_2"
...
setup(
    ...
    description="CARIC2 Baseline 2",
    license="BSD-3-Clause",
    entry_points={
        "console_scripts": [
            "vehicle_controller_openscvx = caric2_baseline_2.vehicle_controller_openscvx:main",
            "openscvx_optimizer_worker = caric2_baseline_2.optimizer_worker:main",
        ],
    },
)
